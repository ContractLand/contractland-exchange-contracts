...
contract('OrderNode',  async(accounts) => {
  ...
  describe("isGreaterThan", async() => {
    ...
    it("A should be greater than B when price is equal and timestamp is older", async() => {
      orderNodeTest.setNodeA(1, 1)
      orderNodeTest.setNodeB(1, 2)
      assert.isTrue(await orderNodeTest.AGreaterThanB())
    })
    
    it("A should not be greater than B when price is equal and timestamp is newer", async() => {
      orderNodeTest.setNodeA(1, 2)
      orderNodeTest.setNodeB(1, 1)
      assert.isFalse(await orderNodeTest.AGreaterThanB())
    })
    
    it("A should not be greater than B when price and timestamp are equal", async() => {
      orderNodeTest.setNodeA(1, 1)
      orderNodeTest.setNodeB(1, 1)
      assert.isFalse(await orderNodeTest.AGreaterThanB())
    })
  ...
  describe("isLessThan", async() => {
    ...
    it("A should be less than B when price is equal and timestamp is older", async() => {
      orderNodeTest.setNodeA(1, 1)
      orderNodeTest.setNodeB(1, 2)
      assert.isTrue(await orderNodeTest.ALessThanB())
    })
    
    it("A should not be less than B when price is equal and timestamp is newer", async() => {
      orderNodeTest.setNodeA(1, 2)
      orderNodeTest.setNodeB(1, 1)
      assert.isFalse(await orderNodeTest.ALessThanB())
    })
    
    it("A should not be less than B when price and timestamp are equal", async() => {
      orderNodeTest.setNodeA(1, 1)
      orderNodeTest.setNodeB(1, 1)
      assert.isFalse(await orderNodeTest.ALessThanB())
    })
