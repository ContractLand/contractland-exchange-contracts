...
contract('AskHeap',  async(accounts) => {
  ...
  describe("update", async() => {
    ...
    it("should do nothing if newPrice is same", async() => {
      const nodes = [
        {id: 1, owner: accounts[0], baseToken: accounts[1], tradeToken: accounts[2], price: 100, amount: 0, timestamp: 0},
        {id: 2, owner: accounts[3], baseToken: accounts[4], tradeToken: accounts[5], price: 10, amount: 0, timestamp: 0},
        {id: 3, owner: accounts[6], baseToken: accounts[7], tradeToken: accounts[8], price: 1, amount: 0, timestamp: 0}
    ...
    it("should not update price if order does not exist", async() => {
      const nodes = [
        {id: 1, owner: accounts[0], baseToken: accounts[1], tradeToken: accounts[2], price: 100, amount: 0, timestamp: 0},
        {id: 2, owner: accounts[3], baseToken: accounts[4], tradeToken: accounts[5], price: 10, amount: 0, timestamp: 0},
        {id: 3, owner: accounts[6], baseToken: accounts[7], tradeToken: accounts[8], price: 1, amount: 0, timestamp: 0}
      ...
      await heap.updatePriceById(nonExistingId, 20)
  ...
  describe("getOrders", async() => {
    it("should return all orders", async () => {
      ...
      const expectedOrders = [
        {id: 1, owner: accounts[0], price: 1, originalAmount: 2, amount: 2, timestamp: 3},
        {id: 2, owner: accounts[3], price: 10, originalAmount: 20, amount: 20, timestamp: 30},
        {id: 3, owner: accounts[6], price: 100, originalAmount: 200, amount: 200, timestamp: 300}
      ]
      const limit = 10
  ...
  describe("getAggregatedOrders", async() => {
    it("should get all orders aggregated by price", async () => {
      const nodes = [
        {id: 1, owner: accounts[0], baseToken: accounts[1], tradeToken: accounts[2], price: 1, amount: 2, timestamp: 3},
        {id: 2, owner: accounts[3], baseToken: accounts[4], tradeToken: accounts[5], price: 1, amount: 20, timestamp: 30},
        {id: 3, owner: accounts[6], baseToken: accounts[7], tradeToken: accounts[8], price: 10, amount: 200, timestamp: 300},
        {id: 4, owner: accounts[9], baseToken: accounts[8], tradeToken: accounts[7], price: 100, amount: 2000, timestamp: 3000}
      ]
    ...
    it("should get orders aggregated by price within limit", async () => {
      const nodes = [
        {id: 1, owner: accounts[0], baseToken: accounts[1], tradeToken: accounts[2], price: 1, amount: 2, timestamp: 3},
        {id: 2, owner: accounts[3], baseToken: accounts[4], tradeToken: accounts[5], price: 1, amount: 20, timestamp: 30},
        {id: 3, owner: accounts[6], baseToken: accounts[7], tradeToken: accounts[8], price: 10, amount: 200, timestamp: 300},
